...
public class TimeCorrelationRunConfig extends MmtcConfigWithTlmSource implements TelemetrySelectionAndAdjustmentOptions {
    private static final Logger logger = LogManager.getLogger();

    public final TimeCorrelationRunConfigInputs runConfigInputs;
    ...
    public static class TimeCorrelationRunConfigInputs {
        ...
        public TimeCorrelationRunConfigInputs(
                ...
                Optional<OffsetDateTime> runUntilErt,
        ...
        public static TimeCorrelationRunConfigInputs copyWithErtRangeSet(TimeCorrelationRunConfigInputs other, OffsetDateTimeRange ertRange) {
            return new TimeCorrelationRunConfigInputs(
                    TargetSampleInputErtMode.RANGE,
                    Optional.of(ertRange.getStart()),
                    Optional.of(ertRange.getStop()),
                    Optional.empty(),
                    Optional.empty(),
                    other.priorCorrelationExactTdt,
                    other.testModeOwltEnabled,
                    other.testModeOwltSec,
                    other.clockChangeRateAssignedValue,
                    other.clockChangeRateAssignedKey,
                    other.clockChangeRateModeOverride,
                    other.additionalSmoothingRecordConfigOverride,
                    other.isDisableContactFilter,
                    other.isCreateUplinkCmdFile,
                    other.dryRunConfig,
                    other.additionalTlmSourceOptions
            );
        }
    }
