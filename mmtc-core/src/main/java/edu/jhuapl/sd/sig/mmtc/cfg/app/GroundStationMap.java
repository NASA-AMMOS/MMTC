...
import edu.jhuapl.sd.sig.mmtc.cfg.base.AbstractConfig;
 ...
 */
public class GroundStationMap extends AbstractConfig {
     ...
     */
    public GroundStationMap(Path groundStationMapPath) {
     ...
     */
    public String getStationName(int pathId) throws MmtcException {
        try {
     ...
     */
    public String getStationName(String stationId) throws MmtcException {
     ...
     */
    public String getStationId(String stationName) throws MmtcException {
        for (Map.Entry<Integer, Pair<String, String>> record : records.entrySet()) {
            Pair<String, String> stationInfo = record.getValue();
