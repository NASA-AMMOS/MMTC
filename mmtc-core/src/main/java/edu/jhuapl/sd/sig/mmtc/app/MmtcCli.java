...
public class MmtcCli {
    ...
    public static ApplicationInvocation determineApplicationCommand(String... cliArgs) throws MmtcException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (appInvoc.command) {
            case CORRELATION: {
                try {
                    TimeCorrelationApp app = new TimeCorrelationApp(appInvoc.args);
                    app.run();
                } catch (Exception ex) {
            ...
            case ROLLBACK: {
                ...
                try {
                    TimeCorrelationRollback rollbackInstance = new TimeCorrelationRollback(appInvoc.args);
            ...
            case CREATE_SANDBOX: {
                logger.info(USER_NOTICE, String.format("Creating new sandbox at %s", appInvoc.args[1]));
                try {
