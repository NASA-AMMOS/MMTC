...
public class TimeCorrelationTarget {
    ...
    private final TimekeepingAdjustmentParameters timekeepingAdjustmentParameters;
    ...
    public TimeCorrelationTarget(List<FrameSample> sampleSet, MmtcConfig mmtcConfig, TimekeepingAdjustmentParameters timekeepingAdjustmentParameters) throws MmtcException {
        this.sampleSet = sampleSet;
        this.targetSample = sampleSet.get(sampleSet.size() / 2);
        this.config = mmtcConfig;
        this.timekeepingAdjustmentParameters = timekeepingAdjustmentParameters;
        this.tk_sclk_fine_tick_modulus = mmtcConfig.getTkSclkFineTickModulus();
    ...
    private void computeCorrelationValues() throws MmtcException, TimeConvertException {
        ...
        if (timekeepingAdjustmentParameters.isTestMode()) {
            owlt = timekeepingAdjustmentParameters.getTestModeOwlt();
        } else {
