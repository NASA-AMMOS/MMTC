...
public class TimeCorrelationApp {
    ...
    private void recordRunHistoryFileBeforeValues() throws MmtcException {
        ...
        runHistoryFileRecord.setValue(RunHistoryFile.PRERUN_SCLK,           currentSclkKernel.getVersionString(config.getSclkKernelBasename(), config.getSclkKernelSeparator()));
