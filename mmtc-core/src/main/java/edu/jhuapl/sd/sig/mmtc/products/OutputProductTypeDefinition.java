...
public abstract class OutputProductTypeDefinition<T extends OutputProductTypeDefinition.ResolvedProductLocation> {
    public static List<OutputProductTypeDefinition> all() {
        List<OutputProductTypeDefinition> all = new ArrayList<>(Arrays.asList(
        ...
        // todo mmtc-10 add plugin output products here
    ...
    public OutputProductTypeDefinition(String name) {
        this.name = name;
    }
