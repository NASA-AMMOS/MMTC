...
public class RawTelemetryTable extends AbstractTimeCorrelationTable {
     ...
     */
    public static BaseOutputProductDefinition.ProductWriteResult appendCorrelationFrameSamplesToRawTelemetryTable(TimeCorrelationContext context) throws MmtcException {
        ...
        return new BaseOutputProductDefinition.ProductWriteResult(
