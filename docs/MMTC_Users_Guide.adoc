...
|REQUIRED
|STR
|The desired URI of the output Raw Telemetry Table file. This file and the Summary Table are commonly co-located.
...
|table.summaryTable.uri
|REQUIRED
|STR
|The desired URI of the output Summary Table file. This file and the Raw Telemetry Table are commonly co-located.
